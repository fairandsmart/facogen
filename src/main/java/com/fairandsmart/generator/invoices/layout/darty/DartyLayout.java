package com.fairandsmart.generator.invoices.layout.darty;
...
import com.fairandsmart.generator.invoices.data.model.Address;
import com.fairandsmart.generator.invoices.data.model.IDNumbers;
...
public class DartyLayout implements InvoiceLayout {
    ...
    public void builtInvoice(InvoiceModel model, PDDocument document, XMLStreamWriter writer) throws Exception {
        ...
        String logo = this.getClass().getClassLoader().getResource("common/logo/Darty.png").getFile();
