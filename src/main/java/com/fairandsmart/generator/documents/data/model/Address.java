...
public class Address {
    ...
    public static class Generator implements ModelGenerator<Address> {
        ...
        private static final String[] addressFiles = new String[] {"common/address/france.csv", "common/address/luxembourg.csv", "common/address/belgium.csv", "common/address/germany.csv"};
