...
public class ReceiptGenerator {
    ...
    public void generateReceipt(com.fairandsmart.generator.documents.layout.receipt.GenericReceiptLayout layout, ReceiptModel model, Path pdf, Path xml, Path img) throws Exception {
        ...
        layout.builtReceipt(model, document, xmlout);
    ...
    public static void main(String args[]) throws Exception {
        ...
        for ( int i=start; i<stop; i++) {
            ...
            ReceiptGenerator.getInstance().generateReceipt(new com.fairandsmart.generator.documents.layout.receipt.GenericReceiptLayout(), model, pdf, xml, img);
