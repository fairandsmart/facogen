package com.fairandsmart.invoices.layout.cdiscount;
...
public class CdiscountLayout implements InvoiceLayout {
    ...
    public void builtInvoice(InvoiceModel model, PDDocument document, XMLStreamWriter writer) throws Exception {
        ...
        String logo = this.getClass().getClassLoader().getResource("logo/cdiscount.jpg").getFile();
        ...
        String msg = this.getClass().getClassLoader().getResource("parts/cdiscount/msg.png").getFile();
        ...
        String footer = this.getClass().getClassLoader().getResource("parts/cdiscount/footer.png").getFile();
